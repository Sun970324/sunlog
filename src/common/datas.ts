...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    brief: {
      ...
      result:
        '수정 누락이 4건에서 0으로 줄었고, 개발 시작 2개월 만에 양대 스토어에 출시해 출시 1주 가입자 300명과 다운로드 500회, 2주 평균 DAU 40, App Store 보드 게임 순위 34위를 기록했습니다.',
    },
    summary:
      '풀이 기법을 배우고 그 실력으로 실시간 랭크 대전을 하는 스도쿠 앱입니다. 마이그레이션 130개, RPC 148개짜리 백엔드까지 직접 만들어 개발 시작 2개월 만에 양대 스토어에 올렸고 출시 1주에 가입자 300명과 다운로드 500회를 기록했습니다. 만드는 동안 스도쿠 카페에 진행 상황을 계속 올렸는데 색상 테마와 기법 설명 방식은 거기서 받은 의견을 반영했습니다.',
    problem:
    ...
    result:
      '개발을 시작한 지 2개월 만에 App Store와 Google Play에 올렸습니다. 스도쿠 카페에 진행 상황을 올리며 모은 사용자가 출시 1주에 300명, 다운로드 500회가 됐고 2주 평균 DAU 40으로 우상향해 App Store 보드 게임 순위 34위까지 올라갔습니다. 공통 테스트를 넣은 뒤로는 한쪽 컨트롤러만 고쳐지고 다른 쪽이 빠지는 일이 다시 생기지 않았습니다.',
    images: [
